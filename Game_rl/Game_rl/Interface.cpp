...
void Interface::ExitMenu()
{
	...
	while (1)
	{
		...
		terminal_printf(10, 10, L"ВЫ ДЕЙСТВИТЕЛЬНО ХОТИТЕ ВЫЙТИ?");
		terminal_printf(10, 14, L"Продолжить игру");
		terminal_printf(10, 16, L"Сохранить и выйти");
		terminal_printf(10, 18, L"Выйти без сохранения");
